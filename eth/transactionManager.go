...
func NewTransactionManager(eth *rpcpool.RPCPool, gpm *GasPriceMonitor, signer transactionSigner, txTimeout time.Duration, maxReplacements int) *TransactionManager {
